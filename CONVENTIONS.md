...
- This bounds what you *add*. Trimming comments already in the file is separate, deliberate work —
  rewrite rather than delete, because a removed invariant costs more than a redundant line.
