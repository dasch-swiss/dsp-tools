...
The comment rule is [`.claude/rules/comments.md`](.claude/rules/comments.md), which every Claude
Code session in this repository loads ([project rules](https://code.claude.com/docs/en/memory)).
