...
- [ ] A hard-to-reverse, boundary-crossing decision (new cross-component dependency, a rejected alternative,
      a deliberate deviation from `ARCH-MAP.md`'s stated boundary rules) has an ADR in `docs/adr/`
