...
- the project-wide [`default_data_authorship`](../data-model/json-project/overview.md#default_data_authorship)
  ...
  (most easily via the xmllib option `apply_default_resource_authorship=xmllib.ResourceAuthorshipDefault.PROJECT_DEFAULT`), which fills
...
It also contains an XML file [here](https://github.com/dasch-swiss/daschland-scripts/tree/main/data/output).
([Direct download link](https://raw.githubusercontent.com/dasch-swiss/daschland-scripts/refs/heads/main/data/output/data_daschland.xml))
