...
segment.append(excel2xml.make_hasSegmentBounds_prop(start=0, end=10))
segment.append(excel2xml.make_hasTitle_prop("title of the segment"))
segment.append(excel2xml.make_hasDescription_prop("1st description of the segment"))
segment.append(excel2xml.make_hasDescription_prop("2nd description of the segment"))
segment.append(excel2xml.make_hasComment_prop("1st comment to the segment"))
segment.append(excel2xml.make_hasComment_prop("2nd comment to the segment"))
