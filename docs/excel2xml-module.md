...
segment.append(excel2xml.make_hasDescription_prop("description of the segment"))
segment.append(excel2xml.make_hasComment_prop("comment to the segment"))
segment.append(excel2xml.make_hasKeyword_prop("keyword"))
