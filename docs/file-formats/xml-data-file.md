...
- When a string is passed to 
  [`excel2xml.make_(un)formatted_text_prop()`](../excel2xml-module.md#special-characters-in-text-properties)
...
Behavior of `<unformatted-text-prop>`:
...
Behavior of `<formatted-text-prop>`:
