...
| **`mapping add`**        | Replace external ontology mappings from an Excel file<br>`dsp-tools mapping add 0XXX-my-onto-mapping.yaml`       | [→](./data-model/data-model-cli.md#mapping-add)                   |
