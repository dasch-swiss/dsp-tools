...
from .helpers import Actions, BaseError, Cardinality, Context, OntoInfo
...
from .value import BooleanValue, ColorValue, DateValue, DecimalValue, GeomValue, GeonameValue, IntValue, IntervalValue, \
    KnoraStandoffXml, LinkValue, ListValue, TextValue, TimeValue, UriValue, Value, fromJsonLdObj
...
class ResourceInstance(Model):
    ...
    def __init__(self,
                 ...
                 values: Optional[
                     Dict[str, Union[str, List[str], Dict[str, str], List[Dict[str, str]], Value, List[Value]]]] = None):
        super().__init__(con)
        self._iri = iri
        self._label = label
        self._ark = ark
