...
class SingleFileCheckResultResponse(BaseModel):
    """
    SingleFileCheckResultResponse
    """ # noqa: E501
    filename: StrictStr
    checksum_matches: StrictBool = Field(alias="checksumMatches")
    __properties: ClassVar[List[str]] = ["filename", "checksumMatches"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "checksumMatches": obj.get("checksumMatches")
        })
        return _obj
