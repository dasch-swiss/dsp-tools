...
class AdminFilesApi:
    ...
    @validate_call
    def get_admin_files_projectshortcode_filename(
        self,
        ...
        _param = self._get_admin_files_projectshortcode_filename_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PermissionCodeAndProjectRestrictedViewSettings",
    ...
    @validate_call
    def get_admin_files_projectshortcode_filename_with_http_info(
        self,
        project_shortcode: Annotated[StrictStr, Field(description="The shortcode of a project. Must be a 4 digit hexadecimal String.")],
        filename: StrictStr,
        knora_authentication_mfygsltemfzwg2_boon3_ws43_thi2_dimy9: Optional[StrictStr] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PermissionCodeAndProjectRestrictedViewSettings]:
        """get_admin_files_projectshortcode_filename
    ...
    @validate_call
    def get_admin_files_projectshortcode_filename_without_preload_content(
        self,
        project_shortcode: Annotated[StrictStr, Field(description="The shortcode of a project. Must be a 4 digit hexadecimal String.")],
        filename: StrictStr,
        knora_authentication_mfygsltemfzwg2_boon3_ws43_thi2_dimy9: Optional[StrictStr] = None,
    ...
    def _get_admin_files_projectshortcode_filename_serialize(
        self,
        project_shortcode,
        filename,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/admin/files/{projectShortcode}/{filename}',
