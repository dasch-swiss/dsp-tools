...
class ChangePermissionResourceClassApiRequestADM(BaseModel):
    """
    ChangePermissionResourceClassApiRequestADM
    """ # noqa: E501
    for_resource_class: StrictStr = Field(alias="forResourceClass")
    __properties: ClassVar[List[str]] = ["forResourceClass"]
