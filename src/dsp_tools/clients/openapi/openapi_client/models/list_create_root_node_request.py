...
class ListCreateRootNodeRequest(BaseModel):
    """
    ListCreateRootNodeRequest
    """ # noqa: E501
    id: Optional[ListIri] = None
    comments: Comments
    labels: Labels
    name: Optional[ListName] = None
    project_iri: ProjectIri = Field(alias="projectIri")
    __properties: ClassVar[List[str]] = ["id", "comments", "labels", "name", "projectIri"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": ListIri.from_dict(obj["id"]) if obj.get("id") is not None else None,
