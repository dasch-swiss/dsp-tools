...
class ListResponseDto(BaseModel):
    ...
    ListResponseDto
    """ # noqa: E501
    resources: Optional[List[ResourceInfoDto]] = None
    count: StrictInt
    __properties: ClassVar[List[str]] = ["resources", "count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "resources": [ResourceInfoDto.from_dict(_item) for _item in obj["resources"]] if obj.get("resources") is not None else None,
            "count": obj.get("count")
        })
        return _obj
