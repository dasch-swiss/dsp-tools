...
class ListsGetResponseADM(BaseModel):
    """
    ListsGetResponseADM
    """ # noqa: E501
    lists: Optional[List[ListRootNodeInfoADM]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "lists": [ListRootNodeInfoADM.from_dict(_item) for _item in obj["lists"]] if obj.get("lists") is not None else None
        })
        return _obj
