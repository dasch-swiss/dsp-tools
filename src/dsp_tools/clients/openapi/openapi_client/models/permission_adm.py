...
class PermissionADM(BaseModel):
    """
    PermissionADM
    """ # noqa: E501
    name: StrictStr
    additional_information: Optional[StrictStr] = Field(default=None, alias="additionalInformation")
    permission_code: Optional[StrictInt] = Field(default=None, alias="permissionCode")
    __properties: ClassVar[List[str]] = ["name", "additionalInformation", "permissionCode"]
