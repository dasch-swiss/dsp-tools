...
class PermissionDeleteResponseADM(BaseModel):
    """
    PermissionDeleteResponseADM
    """ # noqa: E501
    permission_iri: StrictStr = Field(alias="permissionIri")
    deleted: StrictBool
    __properties: ClassVar[List[str]] = ["permissionIri", "deleted"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "permissionIri": obj.get("permissionIri"),
