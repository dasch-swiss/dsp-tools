...
class PermissionsForProjectGetResponseADM(BaseModel):
    """
    PermissionsForProjectGetResponseADM
    """ # noqa: E501
    permissions: Optional[List[PermissionInfoADM]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "permissions": [PermissionInfoADM.from_dict(_item) for _item in obj["permissions"]] if obj.get("permissions") is not None else None
        })
        return _obj
