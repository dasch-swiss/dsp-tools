...
class Project(BaseModel):
    ...
    description: Optional[List[StringLiteralV2]] = None
    keywords: Optional[List[StrictStr]] = None
    logo: Optional[Logo] = None
    ontologies: Optional[List[StrictStr]] = None
    status: Status
    selfjoin: SelfJoin
    __properties: ClassVar[List[str]] = ["id", "shortname", "shortcode", "longname", "description", "keywords", "logo", "ontologies", "status", "selfjoin"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "description": [StringLiteralV2.from_dict(_item) for _item in obj["description"]] if obj.get("description") is not None else None,
