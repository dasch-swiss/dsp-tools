...
class ResourceInfoDto(BaseModel):
    ...
    ResourceInfoDto
    """ # noqa: E501
    resource_iri: StrictStr = Field(alias="resourceIri")
    ...
    __properties: ClassVar[List[str]] = ["resourceIri", "creationDate", "lastModificationDate", "deleteDate", "isDeleted"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "resourceIri": obj.get("resourceIri"),
