...
class TestGroupGetResponseADM(unittest.TestCase):
    """GroupGetResponseADM unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupGetResponseADM:
        """Test GroupGetResponseADM
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupGetResponseADM`
        """
        model = GroupGetResponseADM()
        if include_optional:
            return GroupGetResponseADM(
    ...
    def testGroupGetResponseADM(self):
        """Test GroupGetResponseADM"""
