...
class TestGroupMembersGetResponseADM(unittest.TestCase):
    """GroupMembersGetResponseADM unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupMembersGetResponseADM:
        """Test GroupMembersGetResponseADM
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupMembersGetResponseADM`
        """
        model = GroupMembersGetResponseADM()
        if include_optional:
            return GroupMembersGetResponseADM(
                members = [
    ...
    def testGroupMembersGetResponseADM(self):
        """Test GroupMembersGetResponseADM"""
