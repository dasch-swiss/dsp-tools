...
class TestListChildNodeADM(unittest.TestCase):
    """ListChildNodeADM unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListChildNodeADM:
        """Test ListChildNodeADM
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListChildNodeADM`
        """
        model = ListChildNodeADM()
        if include_optional:
            return ListChildNodeADM(
                id = '',
                name = '',
