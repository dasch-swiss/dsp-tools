...
class TestListGetResponseADM(unittest.TestCase):
    """ListGetResponseADM unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListGetResponseADM:
        """Test ListGetResponseADM
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListGetResponseADM`
        """
        model = ListGetResponseADM()
        if include_optional:
            return ListGetResponseADM(
    ...
    def testListGetResponseADM(self):
        """Test ListGetResponseADM"""
