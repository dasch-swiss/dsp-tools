...
class TestListNodeADM(unittest.TestCase):
    """ListNodeADM unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListNodeADM:
        """Test ListNodeADM
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListNodeADM`
        """
        model = ListNodeADM()
        if include_optional:
            return ListNodeADM(
