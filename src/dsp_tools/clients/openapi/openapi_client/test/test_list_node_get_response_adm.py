...
class TestListNodeGetResponseADM(unittest.TestCase):
    """ListNodeGetResponseADM unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListNodeGetResponseADM:
        """Test ListNodeGetResponseADM
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListNodeGetResponseADM`
        """
        model = ListNodeGetResponseADM()
        if include_optional:
            return ListNodeGetResponseADM(
    ...
    def testListNodeGetResponseADM(self):
        """Test ListNodeGetResponseADM"""
