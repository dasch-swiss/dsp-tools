...
class TestListRootNodeInfoADM(unittest.TestCase):
    """ListRootNodeInfoADM unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListRootNodeInfoADM:
        """Test ListRootNodeInfoADM
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListRootNodeInfoADM`
        """
        model = ListRootNodeInfoADM()
        if include_optional:
            return ListRootNodeInfoADM(
                id = '',
                project_iri = '',
                name = '',
    ...
    def testListRootNodeInfoADM(self):
        """Test ListRootNodeInfoADM"""
