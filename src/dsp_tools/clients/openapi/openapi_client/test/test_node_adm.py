...
class TestNodeADM(unittest.TestCase):
    """NodeADM unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NodeADM:
        """Test NodeADM
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NodeADM`
        """
        model = NodeADM()
        if include_optional:
            return NodeADM(
