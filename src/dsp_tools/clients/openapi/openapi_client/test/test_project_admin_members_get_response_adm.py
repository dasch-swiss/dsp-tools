...
class TestProjectAdminMembersGetResponseADM(unittest.TestCase):
    """ProjectAdminMembersGetResponseADM unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectAdminMembersGetResponseADM:
        """Test ProjectAdminMembersGetResponseADM
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectAdminMembersGetResponseADM`
        """
        model = ProjectAdminMembersGetResponseADM()
        if include_optional:
            return ProjectAdminMembersGetResponseADM(
                members = [
    ...
    def testProjectAdminMembersGetResponseADM(self):
        """Test ProjectAdminMembersGetResponseADM"""
