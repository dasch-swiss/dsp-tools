...
class TestProjectMembersGetResponseADM(unittest.TestCase):
    """ProjectMembersGetResponseADM unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectMembersGetResponseADM:
        """Test ProjectMembersGetResponseADM
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectMembersGetResponseADM`
        """
        model = ProjectMembersGetResponseADM()
        if include_optional:
            return ProjectMembersGetResponseADM(
                members = [
    ...
    def testProjectMembersGetResponseADM(self):
        """Test ProjectMembersGetResponseADM"""
