...
class TestRootNodeInfoGetResponseADM(unittest.TestCase):
    """RootNodeInfoGetResponseADM unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RootNodeInfoGetResponseADM:
        """Test RootNodeInfoGetResponseADM
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RootNodeInfoGetResponseADM`
        """
        model = RootNodeInfoGetResponseADM()
        if include_optional:
            return RootNodeInfoGetResponseADM(
    ...
    def testRootNodeInfoGetResponseADM(self):
        """Test RootNodeInfoGetResponseADM"""
