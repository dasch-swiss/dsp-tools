...
class TestUserGroupMembershipsGetResponseADM(unittest.TestCase):
    """UserGroupMembershipsGetResponseADM unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserGroupMembershipsGetResponseADM:
        """Test UserGroupMembershipsGetResponseADM
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserGroupMembershipsGetResponseADM`
        """
        model = UserGroupMembershipsGetResponseADM()
        if include_optional:
            return UserGroupMembershipsGetResponseADM(
                groups = [
    ...
    def testUserGroupMembershipsGetResponseADM(self):
        """Test UserGroupMembershipsGetResponseADM"""
