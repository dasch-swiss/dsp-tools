...
class TestUserProjectMembershipsGetResponseADM(unittest.TestCase):
    """UserProjectMembershipsGetResponseADM unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserProjectMembershipsGetResponseADM:
        """Test UserProjectMembershipsGetResponseADM
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserProjectMembershipsGetResponseADM`
        """
        model = UserProjectMembershipsGetResponseADM()
        if include_optional:
            return UserProjectMembershipsGetResponseADM(
                projects = [
    ...
    def testUserProjectMembershipsGetResponseADM(self):
        """Test UserProjectMembershipsGetResponseADM"""
