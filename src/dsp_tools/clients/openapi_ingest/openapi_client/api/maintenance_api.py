...
class MaintenanceApi:
    ...
    def post_maintenance_name(
        ...
        restrict_to_projects: Annotated[Optional[List[StrictStr]], Field(description="Restrict the action to a list of projects, if no project is given apply the action to all projects.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
