...
class AssetCheckResultResponse(BaseModel):
    """
    AssetCheckResultResponse
    """

    summary: AssetCheckResultSummary
    results: Optional[list[AssetCheckResultEntry]] = None
    ...
    def from_dict(cls, obj: Optional[dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "summary": AssetCheckResultSummary.from_dict(obj["summary"])
                if obj.get("summary") is not None
                else None,
                "results": [AssetCheckResultEntry.from_dict(_item) for _item in obj["results"]]
