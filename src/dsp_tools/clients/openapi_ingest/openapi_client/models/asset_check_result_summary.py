...
class AssetCheckResultSummary(BaseModel):
    ...
    """ # noqa: E501
    number_of_assets: StrictInt = Field(alias="numberOfAssets")
    number_of_files: StrictInt = Field(alias="numberOfFiles")
    number_of_checksum_matches: StrictInt = Field(alias="numberOfChecksumMatches")
    __properties: ClassVar[List[str]] = ["numberOfAssets", "numberOfFiles", "numberOfChecksumMatches"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "numberOfAssets": obj.get("numberOfAssets"),
            "numberOfFiles": obj.get("numberOfFiles"),
            "numberOfChecksumMatches": obj.get("numberOfChecksumMatches")
        })
        return _obj
