...
class ProblemType(StrEnum):
    ...
    PROJECT_MEMBERSHIP_COULD_NOT_BE_ADDED = "The project memberships could not be added."
    PROJECT_ADMIN_COULD_NOT_BE_ADDED = "The user could not be added as project admin."
    USER_COULD_NOT_BE_ADDED_TO_GROUP = "The user could not be added to the groups."
