...
class ShaclValidator:
    ...
    def _validate_cardinality(self, rdf_graphs: RDFGraphStrings) -> SHACLValidationReport:
    ...
    def _prepare_cardinality_files(self, rdf_graphs: RDFGraphStrings) -> PostFiles:
    ...
    def _validate_content(self, rdf_graphs: RDFGraphStrings) -> SHACLValidationReport:
    ...
    def _prepare_content_files(self, rdf_graphs: RDFGraphStrings) -> PostFiles:
    ...
    @staticmethod
    def _prepare_validation_files_for_request(data_graph: str, shacl_graph: str) -> PostFiles:
        logger.debug("Serialise files for request.")
        shacl_file = PostFile(file_name="shacl.ttl", fileobj=shacl_graph, content_type="text/turtle")
        data_file = PostFile(file_name="data.ttl", fileobj=data_graph, content_type="text/turtle")
