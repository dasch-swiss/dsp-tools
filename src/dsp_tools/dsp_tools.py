...
def program(user_args: list[str]) -> None:
    ...
    parser_create.add_argument("-u", "--user", type=str, default=default_user, help=username_text)
    parser_create.add_argument("-p", "--password", type=str, default=default_pw, help=password_text)
    ...
    parser_create.add_argument("projectfile", type=str, help="path to the JSON project file")

    # get
    parser_get = subparsers.add_parser(name="get", help="Retrieve a project from a DSP server")
    parser_get.set_defaults(action="get")
    parser_get.add_argument("-u", "--user", type=str, default=default_user, help=username_text)
    parser_get.add_argument("-p", "--password", type=str, default=default_pw, help=password_text)
    ...
    parser_get.add_argument("projectfile", type=str, help="Path to the file the project should be written to")
    ...
    parser_upload.add_argument("-V", "--validate-only", action="store_true", help="Validate the XML file without uploading it")
    ...
    parser_upload.add_argument("xmlfile", type=str, help="path to the XML file containing the data")
    ...
    parser_excel2json.add_argument("data_model_files", type=str, help="Path to the folder containing the Excel files")
    parser_excel2json.add_argument("outfile", type=str, help="Path to the output JSON file")
    ...
    parser_excel_lists.add_argument("excelfolder", type=str, help="Path to the folder containing the Excel file(s)")
    parser_excel_lists.add_argument("outfile", type=str, help="Path to the output JSON file containing the 'lists' section")
    ...
    parser_excel_resources.add_argument("excelfile", type=str, help="Path to the Excel file containing the resources")
    parser_excel_resources.add_argument("outfile", type=str, help="Path to the output JSON file containing the 'resources' section")
    ...
    parser_excel_properties.add_argument("excelfile", type=str, help="Path to the Excel file containing the properties")
    parser_excel_properties.add_argument("outfile", type=str, help="Path to the output JSON file containing the 'properties' section")

    # id2iri
    parser_id2iri = subparsers.add_parser(
        name="id2iri", 
        help="Replace internal IDs in an XML file with their corresponding IRIs from a provided JSON file"
    )
    parser_id2iri.set_defaults(action="id2iri")
    parser_id2iri.add_argument("--outfile", type=str, default=None, help="Path to the XML output file containing the replaced IDs (optional)")
    parser_id2iri.add_argument("-v", "--verbose", action="store_true", help=verbose_text)
    parser_id2iri.add_argument("xmlfile", type=str, help="Path to the XML file containing the data to be replaced")
    parser_id2iri.add_argument("jsonfile", type=str, help="Path to the JSON file containing the mapping of internal IDs and their respective IRIs")
    ...
    parser_excel2xml.add_argument("datafile", type=str, help="Path to the CSV or XLS(X) file containing the data")
    parser_excel2xml.add_argument("shortcode", type=str, help="Shortcode of the project that this data belongs to")
    parser_excel2xml.add_argument("default_ontology", type=str, help="Name of the ontology that this data belongs to")
    ...
    # shutdown DSP-API
    parser_stackdown = subparsers.add_parser(name="stop-stack", help="Shut down the local instance of the DSP stack, and delete all data in it")
