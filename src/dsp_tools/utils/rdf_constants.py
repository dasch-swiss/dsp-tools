...
KNORA_API_HAS_STILL_IMAGE_FILE_VALUE = f"{KNORA_API_PREFIX}hasStillImageFileValue"
KNORA_API_HAS_MOVING_IMAGE_FILE_VALUE = f"{KNORA_API_PREFIX}hasMovingImageFileValue"
KNORA_API_HAS_AUDIO_FILE_VALUE = f"{KNORA_API_PREFIX}hasAudioFileValue"
