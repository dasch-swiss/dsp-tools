...
- Comments and docstrings follow `.claude/rules/comments.md` and `CONVENTIONS.md` -> "Comments"; these are public
  API, and mkdocstrings renders them into `docs/xmllib-docs/`
