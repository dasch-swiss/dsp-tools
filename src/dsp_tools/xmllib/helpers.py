...
def create_footnote_element(
    ...
    if not like_string(footnote_text):
...
def create_standoff_link_to_resource(resource_id: str, displayed_text: str) -> str:
    ...
    Examples:
        ...
        ```
    """
    if not all([like_string(resource_id), like_string(displayed_text)]):
        raise InputError(
            (
...
def create_standoff_link_to_uri(uri: str, displayed_text: str) -> str:
    ...
    Examples:
        ...
        ```
    """
    if not all([like_string(uri), like_string(displayed_text)]):
        raise InputError(
            (
...
def get_list_nodes_from_string_via_list_name(
    ...
    Examples:
        ...
        ```
    """
    if not like_string(string_with_list_labels):
        return []
...
def make_xsd_compatible_id(input_value: str | float | int) -> str:
    ...
    Examples:
        ...
        ```
    """
    if not like_string(input_value):
