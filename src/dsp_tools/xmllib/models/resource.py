...
class Resource:
    ...
    def new(self, res_id: str, restype: str, label: str, permissions: Permissions = Permissions.open) -> Resource:
        return Resource(
            res_id=res_id,
            restype=restype,
            label=label,
    ...
    def add_bool(
        self, value: Any, prop_name: str, permissions: Permissions | None = None, comment: str | None = None
    ) -> Resource:
        self.values.append(BooleanValue(value, prop_name, permissions, comment, self.res_id))
        return self

    def add_bools(
        self, values: list[Any], prop_name: str, permissions: Permissions | None = None, comment: str | None = None
    ) -> Resource:
    ...
    def add_color(
        self, value: int | str, prop_name: str, permissions: Permissions | None = None, comment: str | None = None
    ) -> Resource:
    ...
    def add_date(
        self, value: str, prop_name: str, permissions: Permissions | None = None, comment: str | None = None
    ) -> Resource:
        self.values.append(DateValue(value, prop_name, permissions, comment, self.res_id))
        return self

    def add_dates(
        self, values: list[str], prop_name: str, permissions: Permissions | None = None, comment: str | None = None
    ) -> Resource:
    ...
    def add_decimal(
        self, value: float | str, prop_name: str, permissions: Permissions | None = None, comment: str | None = None
    ) -> Resource:
    ...
    def add_file(self, filename: str, permissions: Permissions | None = None, comment: str | None = None) -> Resource:
        if self.file_value:
            raise InputError(
    ...
    def add_iiif_uri(
        self, iiif_uri: str, permissions: Permissions | None = None, comment: str | None = None
    ) -> Resource:
        if self.file_value:
            raise InputError(
                f"The resource with the ID '{self.res_id}' already contains a file with the name: "
