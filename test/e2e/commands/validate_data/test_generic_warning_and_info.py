...
def no_violations_with_warnings_do_not_ignore_duplicate_files(
    ...
    file = Path("testdata/validate-data/core-validation/no_violations_with_warnings.xml")
...
def no_violations_with_info(
    ...
    xml_file = Path("testdata/validate-data/core-validation/no_violations_with_info.xml")
    id2iri_file = "testdata/validate-data/core-validation/no_violations_with_info_id2iri.json"
