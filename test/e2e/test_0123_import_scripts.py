...
from docs.assets.import_scripts import import_script
...
class TestImportScripts(unittest.TestCase):
    ...
    def test_import_scripts(self) -> None:
        ...
        os.chdir("docs/assets/import_scripts")
        try:
            import_script.main()
        finally:
        ...
        success_on_creation = create_project(
            input_file="docs/assets/import_scripts/import_project.json",
        ...
        success_on_xmlupload = xml_upload(
            input_file="docs/assets/import_scripts/data-processed.xml",
            server="http://0.0.0.0:3333",
