...
from dsp_tools.commands.xmlupload.prepare_xml_input.prepare_xml_input import _get_list_from_server
from dsp_tools.commands.xmlupload.prepare_xml_input.prepare_xml_input import _get_list_iris_from_server
