...
def test_with_replacement():
    ...
    link_val = ParsedValue(HAS_PROP, "test_thing_1", KnoraValueType.LINK_VALUE, None, None, None, 0)
    list_val = ParsedValue(HAS_PROP, orig_list_val, KnoraValueType.LIST_VALUE, None, None, None, 0)
    res = ParsedResource(
        res_id="id",
        res_type=RES_TYPE,
        label="lbl",
