...
from dsp_tools.commands.excel2json.new_lists.utils import from_columns_get_preferred_language
...
class TestGetPreferredLanguageForId:
    ...
    def test_get_preferred_language_for_id_raises(self) -> None:
        ...
        with pytest.raises(InputError, match=msg):
            from_columns_get_preferred_language(columns, "1")
