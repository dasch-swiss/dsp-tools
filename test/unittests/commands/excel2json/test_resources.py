...
class TestCheckCompleteGuiOrder:
    def test_column_does_not_exist(self) -> None:
        ...
        expected_msg = (
            r"In the sheet 'class_name' of the file 'resources\.xlsx', "
            r"the column 'gui_order' does not exist\.\n"
            r"Values have been filled in automatically, "
            r"so that the gui-order reflects the order of the properties in the file\."
        )
    ...
    def test_na_in_row(self) -> None:
        ...
        expected_msg = (
            r"In the sheet 'class_name' of the file 'resources\.xlsx', "
            r"some rows in the column 'gui_order' are empty\.\n"
            r"Values have been filled in automatically, "
            r"so that the gui-order reflects the order of the properties in the file\."
        )
        expected_df = pd.DataFrame({"prop": [1, 2, 3], "gui_order": [1, 2, 3]})
    ...
    def test_error(self) -> None:
        ...
        expected_msg = (
            r"In the sheet 'class_name' of the file 'resources\.xlsx', "
            r"some rows in the column 'gui_order' contain invalid characters "
            r"that could not be converted to an integer\.\n"
            r"Values have been filled in automatically, "
            r"so that the gui-order reflects the order of the properties in the file\."
        )
        expected_df = pd.DataFrame({"prop": [1, 2, 3], "gui_order": [1, 2, 3]})
