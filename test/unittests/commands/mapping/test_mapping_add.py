...
class TestOntologyExists:
    def test_ontology_found(self):
        ...
        with patch("dsp_tools.commands.mapping.mapping_add.OntologyGetClientLive") as mock_cls:
            ...
            assert _check_if_project_and_ontology_exists("http://localhost", "0001", onto_iri) is True
    ...
    def test_ontology_not_found(self):
        with patch("dsp_tools.commands.mapping.mapping_add.OntologyGetClientLive") as mock_cls:
            ...
            mock_cls.return_value = mock_client
            assert _check_if_project_and_ontology_exists("http://localhost", "0001", "http://missing/onto") is False
    ...
    def test_project_ontology_not_found_returns_false(self):
        with patch("dsp_tools.commands.mapping.mapping_add.OntologyGetClientLive") as mock_cls:
            ...
            mock_cls.return_value = mock_client
            assert _check_if_project_and_ontology_exists("http://localhost", "0001", "http://any/onto") is False
    ...
    def test_fatal_error_raises_project_not_found(self):
        with patch("dsp_tools.commands.mapping.mapping_add.OntologyGetClientLive") as mock_cls:
            ...
            with pytest.raises(ProjectNotFoundError):
                _check_if_project_and_ontology_exists("http://localhost", "9999", "http://any/onto")
