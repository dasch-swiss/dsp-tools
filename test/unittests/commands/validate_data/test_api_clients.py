...
@pytest.fixture
def ontology_client(api_con: ApiConnection) -> OntologyClient:
    return OntologyClient(api_con, "9999")


@pytest.fixture
def list_client(api_con: ApiConnection) -> ListClient:
...
class TestOntologyConnection:
    def test_get_ontology_iris_ok(self, ontology_client: OntologyClient) -> None:
        ...
        with patch.object(ontology_client.api_con, "get_with_endpoint", return_value=mock_response) as patched_get:
