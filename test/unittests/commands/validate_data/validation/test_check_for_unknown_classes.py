...
from dsp_tools.commands.validate_data.validation.check_for_unknown_classes import _check_unknown_classes
...
class TestFindUnknownClasses:
    def test_check_unknown_classes_data_ok(self):
        ttl = f"""{PREFIXES}
        ...
        result = _check_unknown_classes(graphs, CLASSES_IN_ONTO)
        assert result is None

    def test_check_unknown_classes_data_wrong(self):
        ttl = f"""{PREFIXES}
        ...
        result = _check_unknown_classes(graphs, used_iris)
    ...
    def test_check_unknown_classes_data_prefix_non_existent(self):
        ttl = f"""{PREFIXES}
