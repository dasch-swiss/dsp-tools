...
def test_diagnose_classes_no_knora_prefix() -> None:
    ...
    assert _diagnose_classes("knoraClassA", onto_tool)
...
def test_diagnose_classes_knora_prefix() -> None:
    ...
    assert _diagnose_classes("knora-api:knoraClassA", onto_tool)
...
def test_diagnose_classes_no_default_prefix() -> None:
    ...
    assert _diagnose_classes(":classA", onto_tool)
...
def test_diagnose_classes_default_prefix() -> None:
    ...
    assert _diagnose_classes("test:classB", onto_tool)
...
def test_identify_ontology() -> None:
    ...
    assert _identify_ontology(":propA", onto_tool) == ("test", "propA")
    assert _identify_ontology("knora-api:knoraPropA", onto_tool) == ("knora-api", "knoraPropA")
    assert _identify_ontology("knoraPropB", onto_tool) == ("knora-api", "knoraPropB")
    assert _identify_ontology("test:propA", onto_tool) == ("test", "propA")
...
def test_identify_ontology_error() -> None:
    ...
    with pytest.raises(
        ...
        _identify_ontology("123654", onto_tool)
