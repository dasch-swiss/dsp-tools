from dsp_tools.commands.xmlupload.iiif_client import IIIFValidatorLive


class TestIIIFMakeInfoJsonUri:
    def test_1(self) -> None:
        test = IIIFValidatorLive(
    ...
    def test_5(self) -> None:
        test = IIIFValidatorLive("https://example.org/image-service/abcd1234/full/max/0/default.jpg", True)
        assert test._make_info_json_uri() == "https://example.org/image-service/abcd1234/info.json"

    def test_6(self) -> None:
        test = IIIFValidatorLive("https://www.example.org/prefix1/abcd1234/80,15,60,75/full/0/native", True)
        assert test._make_info_json_uri() == "https://www.example.org/prefix1/abcd1234/info.json"

    def test_7(self) -> None:
        test = IIIFValidatorLive("http://www.example.org/prefix1/abcd1234/80,15,60.6,75/full/0/native.jpg", True)
        assert test._make_info_json_uri() == "http://www.example.org/prefix1/abcd1234/info.json"


def test_make_info_json_uri_fail() -> None:
    test = IIIFValidatorLive("bla", False)
