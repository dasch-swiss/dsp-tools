...
class TestCsv2xml(unittest.TestCase):
    ...
    def test_find_date_in_string(self) -> None:
        ...
        self.assertEqual(c2x.find_date_in_string("1492-10-12"), "GREGORIAN:CE:1492-10-12:CE:1492-10-12")
        self.assertEqual(c2x.find_date_in_string("Text 476-09-04 text"), "GREGORIAN:CE:476-09-04:CE:476-09-04")
        self.assertEqual(c2x.find_date_in_string("Text476-09-04text"), "GREGORIAN:CE:476-09-04:CE:476-09-04")
        self.assertIsNone(c2x.find_date_in_string("Text 1492-10-32 text"))

        # template as documented in docstring: 26.2.-24.3.1948
        self.assertEqual(c2x.find_date_in_string("Text 2193_01_26 text"), "GREGORIAN:CE:2093-01-26:CE:2093-01-26")
        self.assertEqual(c2x.find_date_in_string("Text2193_01_26text"), "GREGORIAN:CE:2093-01-26:CE:2093-01-26")
        self.assertIsNone(c2x.find_date_in_string("Text 2193_02_30 text"))

        # template as documented in docstring: 27.-28.1.1900
        self.assertEqual(c2x.find_date_in_string("Text 1.3. - 25.4.2022 text"), "GREGORIAN:CE:2022-03-01:CE:2022-04-25")
        self.assertEqual(c2x.find_date_in_string("Text 01.03. - 25.04.2022 text"), "GREGORIAN:CE:2022-03-01:CE:2022-04-25")
        self.assertEqual(c2x.find_date_in_string("Text 29.2.-1.12.1515 text"), "GREGORIAN:CE:1515-02-29:CE:1515-12-01")
        self.assertEqual(c2x.find_date_in_string("Text28.2.-1.12.1515text"), "GREGORIAN:CE:1515-02-28:CE:1515-12-01")
        self.assertIsNone(c2x.find_date_in_string("Text 28.2.-26.2.1515 text"))

        # template as documented in docstring: 1.12.1973 - 6.1.1974
        self.assertEqual(c2x.find_date_in_string("Text 25.-26.2.800 text"), "GREGORIAN:CE:800-02-25:CE:800-02-26")
        self.assertEqual(c2x.find_date_in_string("Text 25. - 26.2.800 text"), "GREGORIAN:CE:800-02-25:CE:800-02-26")
        self.assertIsNone(c2x.find_date_in_string("Text 25.-24.2.800 text"))
        ...
        self.assertEqual(c2x.find_date_in_string("Text 25/12/2022-03/01/2024 text"), "GREGORIAN:CE:2022-12-25:CE:2024-01-03")
        self.assertEqual(c2x.find_date_in_string("Text 25/12/2022 - 03/01/2024 text"), "GREGORIAN:CE:2022-12-25:CE:2024-01-03")
        self.assertEqual(c2x.find_date_in_string("Text25/12/2022 - 03/01/2024text"), "GREGORIAN:CE:2022-12-25:CE:2024-01-03")
        self.assertIsNone(c2x.find_date_in_string("Text 25/12/2022-03/01/2022 text"))
        ...
        # template as documented in docstring: 1907 | 1886/7 | 1849/1850
        #TODO
