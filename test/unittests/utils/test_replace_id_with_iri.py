...
class TestReplaceIdsWithIris:
    def test_with_values(self, iri_resolver):
        ...
        link_val = ParsedValue(HAS_PROP, "r1_id", KnoraValueType.LINK_VALUE, None, None, None, 0)
        list_val = ParsedValue(HAS_PROP, orig_list_val, KnoraValueType.LIST_VALUE, "public", "cmt", None, 0)
        res = ParsedResource(
            res_id="id",
            res_type=RES_TYPE,
            label="lbl",
    ...
    def test_region_preview_value(self, iri_resolver):
        preview_val = ParsedValue(HAS_PROP, "r1_id", KnoraValueType.REGION_PREVIEW_VALUE, None, None, None, 0)
        res = ParsedResource(
            res_id="id",
            res_type=RES_TYPE,
            label="lbl",
...
class TestProcessLinkValue:
    def test_in_lookup(self, iri_resolver):
        val = ParsedValue(HAS_PROP, "r1_id", KnoraValueType.LINK_VALUE, None, None, None, 0)
...
class TestProcessRichtextValue:
    def test_in_lookup(self, iri_resolver):
        ...
        val = ParsedValue(HAS_PROP, text_str, KnoraValueType.RICHTEXT_VALUE, None, None, None, 0)
