...
from dsp_tools.xmllib.helpers import create_list_if_input_is_non_empty
...
class TestCreateListFromString:
    ...
    def test_create_list_if_input_is_non_empty(self, input_value, expected) -> None:
        result = create_list_if_input_is_non_empty(input_value, ",")
