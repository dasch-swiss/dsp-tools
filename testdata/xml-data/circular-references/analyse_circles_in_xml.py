...
def analyse_circles_in_data(xml_filepath: Path, tracer_output_file: str, save_tracer: bool = False) -> None:
    ...
    print("=" * 80)
    graph, rustworkx_index_to_id, edges, node_indices = make_graph(resptr_links, xml_links, all_resource_ids)
    _, _, stash_counter = generate_upload_order(graph, rustworkx_index_to_id, edges, node_indices)
