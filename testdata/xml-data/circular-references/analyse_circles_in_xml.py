...
def analyse_circles_in_data(xml_filepath: Path, tracer_output_file: str, save_tracer: bool = False) -> None:
    ...
    """
    default_ontology, root, _ = validate_and_parse_xml_file(
        input_file=xml_filepath,
        imgdir=".",
    ...
    resptr_links, xml_links, all_resource_ids = create_info_from_xml_for_graph(resources)
